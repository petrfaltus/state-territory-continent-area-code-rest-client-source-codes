...
mkdir %OUT%
"%DOTNET_HOME%\csc.exe" /win32icon:%ICON% /out:%EXECUTABLE% /reference:%DLL% %SOURCE%.cs Web.cs OneItem.cs RestRequest1.cs RestRequest2.cs RestRequest3.cs RestReply1or2.cs RestReply3.cs
